...
DROP TABLE IF EXISTS `resetpasswordrecord`;
...
CREATE TABLE `resetpasswordrecord` (
  ...
  `PasswordReset` int NOT NULL,
  PRIMARY KEY (`RecordID`,`Verificationcode`),
...
LOCK TABLES `resetpasswordrecord` WRITE;
/*!40000 ALTER TABLE `resetpasswordrecord` DISABLE KEYS */;
/*!40000 ALTER TABLE `resetpasswordrecord` ENABLE KEYS */;
UNLOCK TABLES;
